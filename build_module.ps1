# PowerShell script to build the Decisions.MixedRepeaterAdvanced Module

Write-Host "Building Decisions.MixedRepeaterAdvanced Module" -ForegroundColor Green
...
Write-Host "Output: Decisions.MixedRepeaterAdvanced.zip" -ForegroundColor Cyan
